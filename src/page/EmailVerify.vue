<template>
  <div class="success-container">
    ...
    <p>An email has been sent to your inbox. Please check your email to complete the registration process.</p>
...
export default {
  ...
  try {
    ...
    this.errorMessage = "An error occurred while trying to resend the email.";
  } finally {
